        ...
        <main className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <form onSubmit={handleCheckout} className="mt-10 grid gap-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-5 py-4 outline-none transition focus:border-teal-500"
                    placeholder="Anything you want us to know about your site or goals"
                  />
                </div>
            ...
            <aside className="rounded-[2rem] bg-slate-900 p-8 text-white shadow-xl md:p-10">
              ...
              <h2 className="mt-4 text-3xl font-semibold">Monthly AI SEO Service</h2>
        ...
        <main className="mx-auto flex max-w-4xl items-center px-6 py-20 lg:px-10">
          <section className="w-full rounded-[2.5rem] border border-slate-200 bg-white p-10 text-center shadow-xl md:p-14">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              Your order has been received successfully. We will begin processing your monthly AI SEO service and follow up using the email address you provided.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              ...
              <button
                ...
                className="rounded-full border border-slate-300 bg-white px-8 py-4 text-sm font-semibold text-slate-700 transition hover:border-slate-400"
              >
                View order page
              </button>
            </div>
    ...
    <div className="min-h-screen bg-[#f7f8fb] text-slate-800">
            ...
            <div className="mt-14">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                {whoFor.map((item) => (
                  <div
                    key={item}
                    className="rounded-2xl bg-white/80 p-4 text-sm text-slate-700 shadow-sm"
                  >
                    ✓ {item}
                  </div>
                ))}
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[2rem] bg-white p-10 shadow-sm ring-1 ring-slate-200">
            ...
            <h2 className="mt-5 text-4xl font-semibold tracking-tight text-slate-800 md:text-5xl">
              We’re a 100% AI company.
            </h2>
            <div className="mt-6 h-1 w-20 rounded-full bg-teal-400" />
            <p className="mt-8 text-xl font-medium leading-9 text-slate-700">
              Fast analysis. Clean reporting. Technical SEO checks in seconds.
            </p>
            <p className="mt-6 text-lg leading-8 text-slate-600">
          ...
          <div className="rounded-[2rem] bg-slate-900 p-10 text-white shadow-xl">
            <div className="space-y-4 text-lg text-slate-100">
              <div className="flex items-center gap-3">
                <span className="text-teal-300">→</span> 100% AI-operated SEO workflow
              </div>
              <div className="flex items-center gap-3">
                <span className="text-teal-300">→</span> Website audits processed in seconds
              </div>
              <div className="flex items-center gap-3">
                <span className="text-teal-300">→</span> Monthly reports with prioritized fixes
              </div>
              <div className="flex items-center gap-3">
                <span className="text-teal-300">→</span> Keyword ranking review included
              </div>
              <div className="flex items-center gap-3">
                <span className="text-teal-300">→</span> Google framework checks included
              </div>
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {process.map((item) => (
            <div key={item.step} className="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200">
              <div className="text-sm font-semibold tracking-[0.25em] text-teal-600">
                {item.step}
              </div>
      ...
      <section id="pricing" className="mx-auto max-w-5xl px-6 pb-24 pt-20 lg:px-10">
        <div className="rounded-[2.5rem] border border-slate-200 bg-white p-10 text-center shadow-xl shadow-slate-200/50 md:p-14">
          <div className="text-sm font-semibold uppercase tracking-[0.3em] text-teal-600">
            Pricing
          </div>
          <h2 className="mt-5 text-4xl font-semibold tracking-tight text-slate-800 md:text-5xl">
          ...
          <p className="mt-4 text-xl font-medium text-slate-700">
            No setup fee. No unnecessary complexity.
          </p>
